...
const SearchMovie = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-black text-white">
            {/* HERO */}
            <section className="min-h-screen pb-8 md:pb-16 bg-blue-600/10 flex flex-col justify-center items-center gap-4 md:gap-6 overflow-hidden p-4 md:p-6">
                ...
                {/* FILTER */}
                {filterOpen && (
                    <div className="mt-4 md:mt-6 bg-white/5 backdrop-blur-md p-4 md:p-6 rounded-2xl md:rounded-3xl w-full max-w-4xl mx-4">
                        ...
                        {movies.slice(0, slice).map((movie) => (
                            ...
                            >
                                ...
                                <Star
                                    ...
                                    className="absolute top-3 md:top-4 right-3 md:right-4 cursor-pointer w-5 h-5 md:w-6 md:h-6"
                                ...
                                <button
                                    ...
                                    text-white rounded-full font-semibold px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm"
                                >
                                    + Watchlist
                                </button>
                            </div>
